...
describe('NFTCollection', () => {
    ...
    describe('Minting', () => {
        ...
        it('should handle multiple mints', async () => {
            await nFTCollection.send(user1.getSender(), { value: toNano('0.1') }, { $$type: 'Mint', queryId: 1n, itemContent: itemContent });

            await nFTCollection.send(user2.getSender(), { value: toNano('0.1') }, { $$type: 'Mint', queryId: 2n, itemContent: itemContent });
